...
public:
    ...
    QAction *actionEnable_selfview;
    QWidget *centralWidget;
    QGridLayout *gridLayout_2;
    QVBoxLayout *verticalLayout;
    QHBoxLayout *horizontalLayout;
    QToolButton *toolButton_call;
    QToolButton *toolButton_add_call;
    QGroupBox *groupBox;
    QGridLayout *gridLayout;
    QLineEdit *lineEdit_Uri;
    QToolButton *toolButton_Hangup;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        action_Homepage->setObjectName(QString::fromUtf8("action_Homepage"));
        actionEnable_selfview = new QAction(MainWindow);
        actionEnable_selfview->setObjectName(QString::fromUtf8("actionEnable_selfview"));
        actionEnable_selfview->setCheckable(true);
        ...
        toolButton_call = new QToolButton(centralWidget);
        toolButton_call->setObjectName(QString::fromUtf8("toolButton_call"));

        horizontalLayout->addWidget(toolButton_call);

        toolButton_add_call = new QToolButton(centralWidget);
        toolButton_add_call->setObjectName(QString::fromUtf8("toolButton_add_call"));

        horizontalLayout->addWidget(toolButton_add_call);
        ...
        sizePolicy1.setHeightForWidth(lineEdit_Uri->sizePolicy().hasHeightForWidth());
        lineEdit_Uri->setSizePolicy(sizePolicy1);

        gridLayout->addWidget(lineEdit_Uri, 0, 0, 1, 1);


        horizontalLayout->addWidget(groupBox);

        toolButton_Hangup = new QToolButton(centralWidget);
        toolButton_Hangup->setObjectName(QString::fromUtf8("toolButton_Hangup"));

        horizontalLayout->addWidget(toolButton_Hangup);
        ...
        sizePolicy2.setHeightForWidth(groupBox_identity->sizePolicy().hasHeightForWidth());
        groupBox_identity->setSizePolicy(sizePolicy2);
        verticalLayout_2 = new QVBoxLayout(groupBox_identity);
        verticalLayout_2->setSpacing(0);
        verticalLayout_2->setContentsMargins(0, 0, 0, 0);
        verticalLayout_2->setObjectName(QString::fromUtf8("verticalLayout_2"));
        comboBox_account = new QComboBox(groupBox_identity);
        comboBox_account->setObjectName(QString::fromUtf8("comboBox_account"));

        verticalLayout_2->addWidget(comboBox_account);
        ...
        sizePolicy3.setHeightForWidth(lineEdit_phonenumber->sizePolicy().hasHeightForWidth());
        lineEdit_phonenumber->setSizePolicy(sizePolicy3);
        ...
        comboBox_group = new QComboBox(groupBox_list);
        ...
        menu_Options->addAction(actionEnable_selfview);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        action_Homepage->setText(QApplication::translate("MainWindow", "Homepage", 0, QApplication::UnicodeUTF8));
        actionEnable_selfview->setText(QApplication::translate("MainWindow", "enable selfview", 0, QApplication::UnicodeUTF8));
        toolButton_call->setText(QApplication::translate("MainWindow", "...", 0, QApplication::UnicodeUTF8));
        toolButton_add_call->setText(QApplication::translate("MainWindow", "...", 0, QApplication::UnicodeUTF8));
        groupBox->setTitle(QApplication::translate("MainWindow", "Phone number or SIP address", 0, QApplication::UnicodeUTF8));
        toolButton_Hangup->setText(QApplication::translate("MainWindow", "...", 0, QApplication::UnicodeUTF8));
