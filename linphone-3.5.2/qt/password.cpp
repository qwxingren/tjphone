...
void password::on_buttonBox_accepted()
{
	...
	linphone_auth_info_set_passwd(_info, ui->lineEdit_password->text().toLocal8Bit().data());
	linphone_auth_info_set_userid(_info, ui->lineEdit_userid->text().toLocal8Bit().data());
