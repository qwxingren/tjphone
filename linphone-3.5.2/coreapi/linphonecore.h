...
const LinphoneAddress * linphone_call_get_to(const LinphoneCall *call);
const LinphoneAddress * linphone_call_get_from(const LinphoneCall *call);
char *linphone_call_get_remote_address_as_string(const LinphoneCall *call);
const char *linphone_call_get_remote_username_as_string(const LinphoneCall *call);
...
LinphoneCall * linphone_core_invite_with_params2(LinphoneCore *lc, const char *url, const LinphoneCallParams *params);
